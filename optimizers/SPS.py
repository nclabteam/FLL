...
class StochasticPolyakStepsize(torch.optim.Optimizer):
    """
    Implements stochastic Polyak step-size
    Source: https://github.com/IssamLaradji/sps/blob/master/sps/sps.py
    Paper: Stochastic Polyak Step-size for SGD: An Adaptive Learning Rate for Fast Convergence
    PDF: https://arxiv.org/pdf/2002.10542
    """
    def __init__(
        self,
        params,
